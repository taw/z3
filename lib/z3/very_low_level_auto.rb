module Z3
  module VeryLowLevel
    ...
    attach_function :Z3_fpa_is_numeral, [:ctx_pointer, :ast_pointer], :bool
    ...
    attach_function :Z3_mk_seq_at, [:ctx_pointer, :ast_pointer, :ast_pointer], :ast_pointer
    attach_function :Z3_mk_seq_contains, [:ctx_pointer, :ast_pointer, :ast_pointer], :ast_pointer
    ...
    attach_function :Z3_mk_seq_prefix, [:ctx_pointer, :ast_pointer, :ast_pointer], :ast_pointer
    attach_function :Z3_mk_seq_replace, [:ctx_pointer, :ast_pointer, :ast_pointer, :ast_pointer], :ast_pointer
    ...
    attach_function :Z3_optimize_translate, [:ctx_pointer, :optimize_pointer, :ctx_pointer], :optimize_pointer
